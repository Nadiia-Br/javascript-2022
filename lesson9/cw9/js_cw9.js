...
//     simpDiv.innerText=`${simpson.name} ${simpson.info}`;
...
for (let course of coursesArray) {
    ...
    durDiv.append(hourDiv, monthDiv);
    durDiv.style.display = 'flex';
    monthDiv.style.width = '30%';
    hourDiv.style.width = '70%';
...
elDiv.append(titleDiv, durDiv, ul);
